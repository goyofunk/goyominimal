...
if ( ! function_exists( 'goyoartdark_front_page_critical_css' ) ) :
	...
	function goyoartdark_front_page_critical_css() {
		...
		// static 사용 금지: 최적화 플러그인이 dequeue 후 재 enqueue 할 때 인라인이 빠지면 히어로·conWrap 레이어가 무너진다.
		$css = <<<'CSS'
...
body.front-page .mainhero.mainhero-wrapper,body.goyo-home-overlay .mainhero.mainhero-wrapper{position:fixed !important; top:0 !important; left:0 !important; right:0 !important; width:100% !important; margin:0 !important; box-sizing:border-box !important; height:var(--goyo-hero-height,100vh) !important; min-height:var(--goyo-hero-height,100vh) !important; z-index:2 !important;}
body.admin-bar.front-page .mainhero.mainhero-wrapper,body.admin-bar.goyo-home-overlay .mainhero.mainhero-wrapper{top:32px !important; height:calc(var(--goyo-hero-height,100vh) - 32px) !important; min-height:calc(var(--goyo-hero-height,100vh) - 32px) !important;}
