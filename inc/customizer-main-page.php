 ...
 *
 * 부모(goyobase)가 갖는 것(모든 자식 공유): sanitize 콜백·selective refresh partial
 * — goyobase/inc/customizer/main-page-*.php 참조. Unicorn 컨트롤은 이 테마에서 제외
 * ( functions.php 의 unicorn_enabled => false — goyoartdark·goyoartlight 전용 ).
 *
